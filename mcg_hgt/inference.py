...
def _build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--data_dir", required=True, help="Directory containing edges and similarity tables.")
    parser.add_argument("--ligand_embed", required=True, help="Ligand embedding file: CSV, NPY, NPZ, PT, or PTH.")
    parser.add_argument("--target_embed", required=True, help="Target embedding file: CSV, NPY, NPZ, PT, or PTH.")
    parser.add_argument("--checkpoint", required=True, help="Trained model checkpoint.")
    parser.add_argument("--pairs", required=True, help="CSV with source,target columns or two unnamed columns.")
